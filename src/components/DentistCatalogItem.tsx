            ...
            <Link href={`/dentistPage/${data.id}`}>
                    <div data-test={`dentist-item-${data.name}`} className='font-serif absolute w-full h-[100%] bg-white rounded-2xl hover:bg-stone-100 hover:shadow-xl'>
                        <div className=' top-[10%] left-[55%] absolute'>
                            ...
                            <div className='sm:text-md md:text-xl lg:text-2xl text-bold'>{data.name}</div>
                            <div className='sm:text-md md:text-lg lg:text-xl text-bold'>{data.expertist}</div>
                            <div className='sm:text-md md:text-lg lg:text-xl text-bold'>{data.tel}</div>
                        </div>
